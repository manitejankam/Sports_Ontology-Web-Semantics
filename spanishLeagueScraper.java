...
public class spanishLeagueScraper {
		...
		public static void main(String[] args) throws IOException {
			...
			for(leagueStartYr=2014;leagueStartYr>=2010;leagueStartYr--){
				...
				String baseurl = "http://www.footballsquads.co.uk/spain/";
				String teamNameURL="";
			String teamName="";
			leageJSONFile = new File("spanishLaliga"+leagueStartYr+".json");
			baseurl+=leagueStartYr+"-"+(leagueStartYr+1)+"/spalali.htm";
	...
	*/
	        ...
	        for (Element link : links) {
	        	...
	        	fetchPlayerDetails(baseurl, teamNameURL, teamName);
	        	cnt++;
	        	//if(cnt==2) break;
		...
		public static void fetchPlayerDetails(String baseURL, String teamURL, String teamName) throws IOException{
			String base="http://www.footballsquads.co.uk/spain/2012-2013/";
			String serNo="";
			String playerName="";
			String nat="";
			String Pos="";
